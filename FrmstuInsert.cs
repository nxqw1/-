...
namespace WindowsFormsApp2
{
    public partial class FrmstuInsert : Form
    {
        ...
        {
            string sql = string.Format("Insert into student(sno,sname,ssex,sage,sdept,spwd) values('{0}','{1}','{2}',{3},'{4}','{5}')",
                tbsno.Text,tbsname.Text,tbssex.Text,tbsage.Text,tbsdept.Text,tbspwd.Text);
